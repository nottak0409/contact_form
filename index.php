  ...
  <div class = "container">
    ...
    <form id="form" action="contact/confirm.php" method="post" name="form" onsubmit="return validate()">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="氏名" value="<?php echo h($_SESSION["name"]) ?>">
      </div>
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="email" name="email" placeholder="メールアドレス" value="<?php echo h($_SESSION["email"]) ?>">
      </div>
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="email_check" name="email_check" placeholder="メールアドレス(確認)" value="<?php echo h($_SESSION["email_check"]) ?>">
      </div>
      <div class="form-group">
        <label for="tel">お電話番号(半角英数字)(必須)
          <span class="error text-danger"><?php if (isset ($_SESSION["error_tel"] ) ) echo h($_SESSION["error_tel"]); ?></span>
        </label>
        <input type="text" class="form-control" id="tel" name="tel" placeholder="電話番号" value="<?php echo h($_SESSION["tel"]) ?>">
      </div>
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="subject" name="subject" placeholder="件名" value="<?php echo h($_SESSION["subject"]) ?>">
      </div>
      <div class="form-group">
        ...
        <textarea class="form-control" id="contact" name="contact" placeholder="お問い合わせ内容（1000文字まで)(必須)" row=3><?= h($_SESSION["contact"]); ?></textarea>
      </div>
